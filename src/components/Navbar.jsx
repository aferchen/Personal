...
function Navbar() {
  return (
    <div className="w-full fixed top-0 left-0 z-50 flex justify-center py-3">
      <div className="flex justify-between items-center max-w-6xl w-full px-6 md:px-10">
        ...
        {/* Navigation Links */}
        <nav className="md:flex items-center bg-white shadow-md px-6 py-3 rounded-full">
